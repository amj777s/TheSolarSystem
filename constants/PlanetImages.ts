...
const planetImages = {
    Mercury: require('../assets/images/planets/mercury.webp'),
    Venus: require('../assets/images/planets/venus.webp'),
    Earth: require('../assets/images/planets/earth.webp'),
    Mars: require('../assets/images/planets/mars.webp'),
