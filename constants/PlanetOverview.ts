    ...
    mercury: [
        {
            ...
            img: require('../assets/images/facts/mercury/smallest.webp')
        },
        {
            title: "Inside Track",
            fact: "Mercury orbits closest to the Sun",
            img: require('../assets/images/facts/mercury/insideTrack.webp')
        },
        {
            title: "Fast Times",
            fact: "A year on Mercury is 88 days on Earth",
            img: require('../assets/images/facts/mercury/fastTimes.webp')
        },
        {
            title: "Rouge Surface",
            fact: "Mercury is cratered like the Moon",
            img: require('../assets/images/facts/mercury/roughSurface.webp')
        },
        {
            title: "Bring a SpaceSuit",
            fact: "Mercury has a thin atmosphere",
            img: require('../assets/images/facts/mercury/bringASpaceSuit.webp')
        },
        {
            title: "Moonless",
            fact: "Mercury has no moons",
            img: require('../assets/images/facts/mercury/moonless.webp')
        },
        {
            title: "Ringless",
            fact: "Mercury has no rings",
            img: require('../assets/images/facts/mercury/ringless.webp')
        },
        {
            title: "Tough Spot",
            fact: "Mercury can't support life as we know it",
            img: require('../assets/images/facts/mercury/toughSpot.webp')
        },
        {
            title: "Wear Eye Protection",
            fact: "Sunlight is 11 times brighter on Mercury",
            img: require('../assets/images/facts/mercury/wearEyeProtection.webp')
        },
        {
            title: "Greatest Hit",
            fact: "The Caloris Basin is a Texas-sized impact crater",
            img: require('../assets/images/facts/mercury/greatestHit.webp')
        }
    ],
    venus: [
        {
    ...
    earth: [
        {
            ...
            img: require('../assets/images/facts/jupiter/bigAndLight.webp') // REPLACE WITH EARTH 
            
        },
        {
            title: "Third Rock from the Sun",
            fact: "Earth is 1 Au from the Sun",
            img: require('../assets/images/facts/venus/twinSister.webp') //REPLACE WITH EARTH
    ...
    jupiter: [
        {
            ...
            img: require('../assets/images/facts/jupiter/theBiggest.webp')
        },
        {
            title: "Fifth from the Sun",
            fact: "Jupiter is 5.2 AU from the Sun",
            img: require('../assets/images/facts/jupiter/fifthFromTheSun.webp')
        },
        {
            title: "Short and Long",
            fact: "Jupiter's day last only 10 Earth hours, however its year is 12 Earth years",
            img: require('../assets/images/facts/jupiter/ShortandLong.webp')
        },
        {
            title: "Nowhere to Land",
            fact: "Jupiter has no solid surface; It may have an Earth-sized core",
            img: require('../assets/images/facts/jupiter/nowhereToLand.webp')
        },
        {
            title: "Big and Light",
            fact: "Jupiter's atmosphere is mostly hydrogen and helium",
            img: require('../assets/images/facts/jupiter/bigAndLight.webp')
        },
        {
            title: "Many Moons",
            fact: "As of July 2023, Jupiter had 95 moons",
            img: require('../assets/images/facts/jupiter/manyMoons.webp')
        },
        {
            title: "Faint Rings",
            fact: "The rings were spotted in 1979",
            img: require('../assets/images/facts/jupiter/faintRings.webp')
        },
        {
            title: "Exploration",
            fact: "Seven robots flew by; two stayed in orbit",
            img: require('../assets/images/facts/jupiter/exploration.webp')
        },
        {
            title: "Ingredients for Life?",
            fact: "Jupiter can't support life as we know it",
            img: require('../assets/images/facts/jupiter/ingredientsForlIfe.webp')
        },
        {
            title: "Super Storm",
            fact: "The Great Red Spot is a storm that has raged for over 100 years",
            img: require('../assets/images/facts/jupiter/superStorm.webp')
        }
    ],
    saturn: [
        {
            ...
            img: require('../assets/images/facts/saturn/secondLargest.webp')
        },
        {
            title: "Sixth from the Sun",
            fact: "Saturn is 9.5 AU from the Sun",
            img: require('../assets/images/facts/saturn/sixthFromTheSun.webp')
        },
        {
            title: "Long Year",
            fact: "It takes 29 Earth Years for Saturn to orbit the Sun",
            img: require('../assets/images/facts/saturn/longYear.webp')
        },
        {
            title: "No Surface",
            fact: "This gas giant world may have a small core",
            img: require('../assets/images/facts/saturn/noSurface.webp')
        },
        {
            title: "Bring a Spacesuit",
            fact: "Saturn's atmosphere is mostly hydrogen and helium",
            img: require('../assets/images/facts/saturn/bringASpacesuit.webp')
        },
        {
            title: "King of the Moons",
            fact: "Saturn has 146 moons",
            img: require('../assets/images/facts/saturn/kingOfTheMoons.webp')
        },
        {
            title: "The Nicest Rings",
            fact: "Eight rings make for a spectacular system",
            img: require('../assets/images/facts/saturn/theNicestRings.webp')
        },
        {
            title: "Distinct Destination",
            fact: "Four missions visted Satun; one has orbited",
            img: require('../assets/images/facts/saturn/distantDestinations.webp')
        },
        {
            title: "Not Suitable For Life",
            fact: "Saturn can't support life as we know it",
            img: require('../assets/images/facts/saturn/notSuitableForLife.webp')
        },
        {
            title: "Cloud Hexagon",
            fact: "A powerful jet stream shapes the clouds",
            img: require('../assets/images/facts/saturn/cloudHexagon.webp')
        }
    ],
    uranus: [
        {
    ...
    neptune: [
        {
            ...
            img: require('../assets/images/facts/neptune/bigBlue.webp')
        },
        {
            title: "Number Eight",
            fact: "Neptune is 30 AU from the Sun",
            img: require('../assets/images/facts/neptune/numberEight.webp')
        },
        {
            title: "A Neptunian Year",
            fact: "Neptune takes 165 Earth Years to go around the Sun",
            img: require('../assets/images/facts/neptune/aNeptunianYear.webp')
        },
        {
            title: "Ice Giant",
            fact: "The densest of the giant planets",
            img: require('../assets/images/facts/neptune/iceGiant.webp')
        },
        {
            title: "14 Moons",
            fact: "named for sea gods and nymphs in Greek mythology",
            img: require('../assets/images/facts/neptune/fourteenYears.webp')
        },
        {
            title: "Rings and Arcs",
            fact: "Neptune has five rings and four more ring arcs",
            img: require('../assets/images/facts/neptune/ringsAndArcs.webp')
        },
        {
            title: "Solo Voyager",
            fact: "Voyager 2 is the only spacecraft to visit Neptune",
            img: require('../assets/images/facts/neptune/soloVoyager.webp')
        },
        {
            title: "Bring a Spacesuit",
            fact: "Atmosphere is molecular hydrogen and atomic helium with a bit of methane",
            img: require('../assets/images/facts/neptune/bringASpaceCraft.webp')
        },
        {
            title: "No Signs",
            fact: "Neptune cannot support life as we know it",
            img: require('../assets/images/facts/neptune/noSigns.webp')
        },
        {
            title: "Orbit Crossing",
            fact: "Pluto sometimes comes closer to the Sun than Neptune",
            img: require('../assets/images/facts/neptune/orbitCrossing.webp')
        }
    ]
}
